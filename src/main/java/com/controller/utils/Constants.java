...
public class Constants {
    ...
    public static final String MAIN_MENU_NAME = "LSA TOOLS MAIN MENU";
    public static final String EMJL_PROCESS_MENU_NAME = "EMJL LSA TOOLS MENU";
    public static final String FILES_JOB_MENU_NAME = "WORKING WITH FILES MENU";
